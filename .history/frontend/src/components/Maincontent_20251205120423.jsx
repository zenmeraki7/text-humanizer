// MainContent.jsx - Responsive main component with Emerald Dusk & White Theme
  ...
  return (
    <div style={mainContentStyles}>
      ...
      <div className="card" style={cardStyles}>
        ...
        {error && (
          <div style={{
            background: error.startsWith('✅') ? 'rgba(5, 150, 105, 0.1)' : 'rgba(220, 38, 38, 0.1)',
            border: error.startsWith('✅') ? '1px solid rgba(5, 150, 105, 0.3)' : '1px solid rgba(220, 38, 38, 0.3)',
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              onBlur={(e) => e.target.style.borderColor = 'rgba(5, 150, 105, 0.3)'}
            />
          </div>
