// Styles for ToneComponents using CSS-in-JS approach with light theme
...
export const chipStyles = {
  ...
  boxShadow: '0 4px 12px rgba(2, 56, 89, 0.3)',
  textAlign: 'center'
};
...
export const getTabStyles = (isActive) => ({
  ...
  border: 'none',
  backgroundColor: isActive ? '#023859' : 'transparent',
  background: isActive 
    ? 'linear-gradient(135deg, #023859 0%, #034a73 100%)' 
    : 'rgba(2, 56, 89, 0.05)',
  color: isActive ? '#fff' : '#456578',
  ...
  boxShadow: isActive ? '0 8px 24px rgba(2, 56, 89, 0.3)' : 'none'
});
...
export const getModeButtonStyles = (isActive) => ({
  padding: 'clamp(16px, 3vw, 20px)',
  border: `2px solid ${isActive ? '#023859' : 'rgba(2, 56, 89, 0.2)'}`,
  backgroundColor: isActive ? 'rgba(2, 56, 89, 0.1)' : 'rgba(255, 255, 255, 0.5)',
  borderRadius: 'clamp(12px, 2vw, 16px)',
  cursor: 'pointer',
  transition: 'all 0.3s ease-in-out',
  textAlign: 'left',
  outline: 'none',
  transform: isActive ? 'translateY(-2px)' : 'none',
  boxShadow: isActive ? '0 8px 24px rgba(2, 56, 89, 0.2)' : 'none'
});
...
export const getIconButtonStyles = (disabled) => ({
  ...
  border: '1px solid rgba(2, 56, 89, 0.3)',
  backgroundColor: disabled ? 'rgba(2, 56, 89, 0.05)' : 'rgba(2, 56, 89, 0.1)',
  color: disabled ? '#94a3b8' : '#023859',
  borderRadius: 'clamp(6px, 1vw, 8px)',
...
export const getTextareaStyles = (isFocused) => ({
  ...
  border: `2px solid ${isFocused ? '#023859' : 'rgba(2, 56, 89, 0.3)'}`,
  borderRadius: 'clamp(12px, 2vw, 16px)',
  ...
  lineHeight: '1.6',
  boxShadow: isFocused ? '0 0 0 4px rgba(2, 56, 89, 0.1)' : 'none'
});
...
export const getProcessButtonStyles = (disabled) => ({
  ...
  border: 'none',
  backgroundColor: disabled ? 'rgba(2, 56, 89, 0.3)' : '#023859',
  background: disabled 
    ? 'rgba(2, 56, 89, 0.3)' 
    : 'linear-gradient(135deg, #023859 0%, #034a73 100%)',
  color: '#fff',
  ...
  boxShadow: disabled ? 'none' : '0 8px 24px rgba(2, 56, 89, 0.3)',
  whiteSpace: 'nowrap'
});
