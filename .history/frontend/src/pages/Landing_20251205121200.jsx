...
const lightEmeraldTheme = createTheme({
  palette: {
    mode: 'light',
    primary: {
      main: '#047857',
  ...
  typography: {
    ...
    h1: {
      fontWeight: 800,
      fontSize: '3.5rem',
      background: 'linear-gradient(135deg, #047857 0%, #2dd4bf 50%, #10b981 100%)',
...
export default function Landing() {
  ...
  const features = [
    ...
    },
    {
      ...
      gradient: "linear-gradient(135deg, #047857, #14b8a6)",
    },
    {
      icon: "🔐",
  ...
  return (
    <ThemeProvider theme={lightEmeraldTheme}>
      <Box
        sx={{
          minHeight: '100vh',
          background: 'linear-gradient(135deg, #e0f2f1 0%, #f1f8f6 50%, #fafcfb 100%)',
          position: 'relative',
          overflow: 'hidden',
        }}
      >
            ...
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              <Box sx={{ display: 'flex', gap: 4, justifyContent: 'center', flexWrap: 'wrap' }}>
                {[
                  ...
                  { label: '1M+ Words Processed', color: '#0891b2' },
                  { label: 'Enterprise Security', color: '#047857' },
                ].map((stat, index) => (
                  <Chip
                    key={index}
                    label={stat.label}
            ...
            <Card
              sx={{
                ...
                '&::before': {
                  ...
                  right: 0,
                  bottom: 0,
                  background: 'linear-gradient(135deg, rgba(5, 150, 105, 0.05), rgba(45, 212, 191, 0.05))',
                  zIndex: 0,
                },
              }}
            >
