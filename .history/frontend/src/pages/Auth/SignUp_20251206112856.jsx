          ...
          <div style={formRowStyles}>
            <div style={formGroupStyles}>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.borderColor = errors.firstName ? '#ef4444' : 'rgba(2, 56, 89, 0.2)';
            ...
            <div style={formGroupStyles}>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.borderColor = errors.lastName ? '#ef4444' : 'rgba(2, 56, 89, 0.2)';
                  e.target.style.boxShadow = 'none';
                }}
              />
              {errors.lastName && (
          ...
          <div style={formGroupStyles}>
            ...
            {formData.password && (
              <div style={passwordRequirementsStyles}>
                <div style={{ color: '#023859', marginBottom: '8px', fontWeight: '500' }}>Password Requirements:</div>
