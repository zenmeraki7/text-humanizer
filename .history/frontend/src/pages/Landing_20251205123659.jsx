      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            ...
            boxShadow: '0 20px 40px rgba(2, 56, 89, 0.15)',
          },
        },
      },
    },
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            ...
            boxShadow: '0 10px 20px rgba(2, 56, 89, 0.3)',
          },
        },
      },
    },
      ...
      >
        ...
        <Box
          sx={{
            ...
            width: 400,
            height: 400,
            background: 'radial-gradient(circle, rgba(2, 56, 89, 0.15) 0%, transparent 70%)',
            borderRadius: '50%',
        ...
        <Box
          sx={{
            ...
            width: 300,
            height: 300,
            background: 'radial-gradient(circle, rgba(3, 74, 115, 0.15) 0%, transparent 70%)',
            borderRadius: '50%',
            ...
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              <Box sx={{ display: 'flex', gap: 3, justifyContent: 'center', flexWrap: 'wrap', mb: 6 }}>
               <Link to="/humanize" >
                <Button
                  ...
                  size="large"
                  sx={{
                    background: 'linear-gradient(135deg, #023859, #034a73)',
                    color: '#fff',
                    '&:hover': {
                      background: 'linear-gradient(135deg, #012744, #02385a)',
                      boxShadow: '0 10px 30px rgba(2, 56, 89, 0.4)',
                    },
                  }}
                >
                  Start Humanizing
                ...
                <Button
                  ...
                  size="large"
                  sx={{
                    background: 'linear-gradient(135deg, #034a73, #456578)',
                    color: '#fff',
                    '&:hover': {
                      background: 'linear-gradient(135deg, #02385a, #344e5f)',
                      boxShadow: '0 10px 30px rgba(3, 74, 115, 0.4)',
                    },
                  }}
                >
                  Try Detection Free
              ...
              <Link to ="/plagiarism" >
                <Button
                  ...
                  size="large"
                  sx={{
                    background: 'linear-gradient(135deg, #456578, #5a7a8f)',
                    color: '#fff',
                    '&:hover': {
                      background: 'linear-gradient(135deg, #344e5f, #456578)',
                      boxShadow: '0 10px 30px rgba(69, 101, 120, 0.4)',
                    },
                  }}
                >
              ...
              <Box sx={{ display: 'flex', gap: 4, justifyContent: 'center', flexWrap: 'wrap' }}>
                {[
                  { label: '99.9% Accuracy', color: '#023859' },
                  { label: '1M+ Words Processed', color: '#034a73' },
                  { label: 'Enterprise Security', color: '#456578' },
                ].map((stat, index) => (
                  <Chip
                    key={index}
                    label={stat.label}
                    ...
                    <Card
                      sx={{
                        ...
                        border: activeFeature === index 
                          ? '1px solid rgba(2, 56, 89, 0.4)' 
                          : '1px solid rgba(2, 56, 89, 0.2)',
                        '&::before': {
                          content: '""',
                          position: 'absolute',
                          top: 0,
            ...
            <Card
              sx={{
                ...
                '&::before': {
                  ...
                  right: 0,
                  bottom: 0,
                  background: 'linear-gradient(135deg, rgba(2, 56, 89, 0.05), rgba(3, 74, 115, 0.05))',
                  zIndex: 0,
                },
              }}
            >
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                ...
                <Typography variant="h6" color="text.secondary" sx={{ mb: 4, maxWidth: 500, mx: 'auto', fontWeight: 500 }}>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      background: 'linear-gradient(135deg, #012744, #02385a)',
                      boxShadow: '0 15px 35px rgba(2, 56, 89, 0.4)',
