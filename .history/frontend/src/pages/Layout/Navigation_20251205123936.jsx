    ...
    >
      ...
      <div
        ...
        style={{
          ...
          maxWidth: '420px',
          boxShadow: `
            0 25px 50px -12px rgba(2, 56, 89, 0.3),
            0 0 0 1px rgba(2, 56, 89, 0.05),
            0 0 60px rgba(2, 56, 89, 0.2)
          `,
          textAlign: 'center',
          position: 'relative',
          overflow: 'hidden',
      ...
      >
        ...
        <div
          style={{
            ...
            bottom: 0,
            background: `
              radial-gradient(circle at 30% 40%, rgba(2, 56, 89, 0.1) 0%, transparent 50%),
              radial-gradient(circle at 70% 60%, rgba(3, 74, 115, 0.1) 0%, transparent 50%)
            `,
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!isLoggingOut) {
                e.target.style.background = 'rgba(2, 56, 89, 0.2)';
                e.target.style.borderColor = 'rgba(2, 56, 89, 0.5)';
                e.target.style.transform = 'translateY(-2px)';
                e.target.style.boxShadow = '0 8px 25px rgba(2, 56, 89, 0.2)';
              }
            }}
            onMouseLeave={(e) => {
              if (!isLoggingOut) {
                e.target.style.background = 'rgba(2, 56, 89, 0.1)';
      ...
      <HideOnScroll>
        <AppBar
          ...
          sx={{
            ...
            borderBottom: '1px solid rgba(2, 56, 89, 0.1)',
          }}
        >
                ...
                {navItems.map((item) => (
                  <Button
                    ...
                    sx={{
                      position: 'relative',
                      cursor: 'pointer',
                      color: item === 'Logout' ? '#ef4444' : '#023859',
                      fontWeight: 500,
                      '&:hover': {
                        color: item === 'Logout' ? '#dc2626' : '#034a73',
                      ...
                      '&::after': {
                        ...
                        background: item === 'Logout' 
                          ...
                          : 'linear-gradient(135deg, #023859, #034a73)',
                        transition: 'all 0.3s ease',
      ...
      <Drawer
        ...
        sx={{
          '& .MuiDrawer-paper': {
            ...
            backdropFilter: 'blur(20px)',
            borderLeft: '1px solid rgba(2, 56, 89, 0.1)',
          },
        }}
      >
        <Box sx={{ p: 2 }}>
