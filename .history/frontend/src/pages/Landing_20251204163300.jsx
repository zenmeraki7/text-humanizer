...
const darkTheme = createTheme({
  palette: {
    mode: "dark",
    primary: {
      main: "#6B8784",    // main accent
      light: "#7D8F8B",   // lighter accent
      dark: "#2B4242",    // deep accent
    },
    secondary: {
      main: "#93A4AB",    // secondary UI color
    },
    background: {
      default: "#2B4242", // full-page background
      paper: "rgba(195, 198, 195, 0.1)", // based on #C3C6C3
    },
    text: {
      primary: "#C3C6C3",
      secondary: "rgba(195,198,195,0.6)",
    },
  },
  ...
  typography: {
    ...
    h1: {
      fontWeight: 800,
      fontSize: "3.5rem",
      background: "linear-gradient(135deg, #C3C6C3 0%, #93A4AB 100%)",
  ...
  components: {
    MuiCard: {
      styleOverrides: {
        root: {
          background: "rgba(195, 198, 195, 0.08)",
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          "&:hover": {
            backgroundColor: "#7D8F8B",
            boxShadow: "0 8px 20px rgba(107,135,132,0.3)",
          },
        },
      },
    },
