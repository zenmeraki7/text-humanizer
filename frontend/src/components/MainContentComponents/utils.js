...
export const humanizeText = async (text) => {
  console.log("🔍 Starting humanization request...");
  console.log("📍 API URL:", `${API_BASE_URL}/humanize`);
  ...
  try {
    ...
    if (error.name === 'TypeError' && error.message.includes('fetch')) {
      console.error("🌐 Network error - check if server is running on", API_BASE_URL);
    }
